...
\begin{thebibliography}{3}
    ...
    \bibitem {agileSamurai} support page for "The Agile Samurai" Japanese Translation Edition \url{https://github.com/agile-samurai-ja/support} (2024/01/16 アクセス)
    ...
    \bibitem {dijitalDesignSystem} デジタル庁,デザインシステム. \url{https://www.digital.go.jp/policies/servicedesign/designsystem} (2024/01/16 アクセス)
    \bibitem {smartHRDesignSystem} SmartHR,SmartHR Design System. \url{https://smarthr.design/} (2024/01/16 アクセス)
    \bibitem {concept} 玉樹 真一郎．コンセプトのつくりかた.ダイヤモンド社.2012.
    \bibitem {uiDesign} 原田 秀司. UIデザイン必携 ユーザーインターフェースの設計と改善を成功させるために．翔泳社．2022．
\end{thebibliography}
\end{document}
